...
| Tests unitarios | **332 en verde**, 18 ficheros (`npm test`, medido el 15 ago). `npm run lint` y `npm run typecheck` limpios; el build aislado `.next-deploy-verify` compila las 37 páginas e incluye `/api/orders`. |
